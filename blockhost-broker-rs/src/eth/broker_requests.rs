...
pub mod broker_requests {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                (
                    ::std::borrow::ToOwned::to_owned("capacityStatus"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("capacityStatus"),
                            inputs: ::std::vec![],
                            outputs: ::std::vec![
                ...
                (
                    ::std::borrow::ToOwned::to_owned("setCapacityStatus"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("setCapacityStatus"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
    ...
    impl<M: ::ethers::providers::Middleware> BrokerRequests<M> {
        ...
        ///Calls the contract's `capacityStatus` (0x6e77fd2f) function
        pub fn capacity_status(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, u8> {
            self.0
                .method_hash([110, 119, 253, 47], ())
        ...
        ///Calls the contract's `setCapacityStatus` (0xa5664926) function
        pub fn set_capacity_status(
            &self,
            status: u8,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([165, 102, 73, 38], status)
                .expect("method not found (this should never happen)")
        }
    ...
    ///Container type for all input parameters for the `capacityStatus` function with signature `capacityStatus()` and selector `0x6e77fd2f`
    #[derive(
        Clone,
    ...
    #[ethcall(name = "capacityStatus", abi = "capacityStatus()")]
    pub struct CapacityStatusCall;
    ...
    ///Container type for all input parameters for the `setCapacityStatus` function with signature `setCapacityStatus(uint8)` and selector `0xa5664926`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "setCapacityStatus", abi = "setCapacityStatus(uint8)")]
    pub struct SetCapacityStatusCall {
        pub status: u8,
    }
    ...
    pub enum BrokerRequestsCalls {
        CapacityStatus(CapacityStatusCall),
        ...
        SetCapacityStatus(SetCapacityStatusCall),
    ...
    impl ::ethers::core::abi::AbiDecode for BrokerRequestsCalls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded) = <CapacityStatusCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CapacityStatus(decoded));
            }
            ...
            if let Ok(decoded) = <SetCapacityStatusCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetCapacityStatus(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for BrokerRequestsCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::SetCapacityStatus(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for BrokerRequestsCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::CapacityStatus(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::SetCapacityStatus(element) => ::core::fmt::Display::fmt(element, f),
                Self::SubmitRequest(element) => ::core::fmt::Display::fmt(element, f),
                Self::TransferOwnership(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<CapacityStatusCall> for BrokerRequestsCalls {
        fn from(value: CapacityStatusCall) -> Self {
            Self::CapacityStatus(value)
        }
    }
    ...
    impl ::core::convert::From<SetCapacityStatusCall> for BrokerRequestsCalls {
        fn from(value: SetCapacityStatusCall) -> Self {
            Self::SetCapacityStatus(value)
        }
    }
    ...
    ///Container type for all return fields from the `capacityStatus` function with signature `capacityStatus()` and selector `0x6e77fd2f`
    #[derive(
        Clone,
    ...
    pub struct CapacityStatusReturn(pub u8);
    ...
    ///`Request(uint256,address,address,bytes,uint256)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
